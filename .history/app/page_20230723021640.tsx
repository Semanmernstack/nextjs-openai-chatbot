...
export default function Chat() {
  ...
  return (
    <div className=" min-h-screen max-w-7xl mx-auto  flex shadow-2xl flex-col p-5 bg-gray-900  ">
      ...
      <form onSubmit={handleSubmit} className="p-4 boder-2 xs:w-[30%] md:w-[70%] fixed items-center bottom-0  shadow-2xl flex gap-3"     >
        
          <input
            value={input}
            onChange={handleInputChange}
            className="flex  p-6 mt-1 rounded-md bottom-0 outline-none border-none"
