...
export default function Chat() {
  ...
  return (
    <div className=" min-h-screen  max-w-7xl mx-auto  flex shadow-2xl flex-col p-5 bg-gray-900  ">
      ...
      {messages.map(m => (
        <div key={m.id} className="p-2 gap-2 mb-4   ">
          <p className="p-1 shadow-xl italic  ">{m.role}</p>
          <p className="p-3  border-shadow-2xl font-serif bg-zinc-950 text-white">{m.content}</p>
