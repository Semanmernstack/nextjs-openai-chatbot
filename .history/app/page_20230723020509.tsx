...
export default function Chat() {
  ...
  return (
    <div className=" min-h-screen max-w-7xl mx-auto  flex shadow-2xl flex-col p-5 bg-gray-900  ">
      ...
      {messages.map(m => (
        <div key={m.id} className="p-3 gap-2    ">
          <p className="p-1 boder shadow-md bg-blue-800">{m.role}</p>
          <p className="p-1 border shadow-2xl bg-zinc-950 text-white">{m.content}</p>
          {m.role}: {m.content}
        </div>
